...
- [DSA indexer upstream example set](https://github.com/DatasunriseOU/MegaCpp source repository/tree/main/upstream_prs/examples/12_dsa_indexer_memory/README.md)
- [Mamba linear CE upstream example set](https://github.com/DatasunriseOU/MegaCpp source repository/tree/main/upstream_prs/examples/11_mamba_linear_ce/README.md)
- [MegaCpp DSA patch surface](https://github.com/DatasunriseOU/MegaCpp source repository/blob/main/MegaCpp source repository/megatron/dsa_indexer_fused_patch.py)
- [MegaCpp Megatron recipe surface](https://github.com/DatasunriseOU/MegaCpp source repository/blob/main/MegaCpp source repository/recipes/nam56r_megatron.py)
